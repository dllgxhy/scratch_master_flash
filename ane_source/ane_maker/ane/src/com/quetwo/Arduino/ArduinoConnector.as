...
package com.quetwo.Arduino
{
	...
	public class ArduinoConnector extends EventDispatcher
	{
		...
		public function getComPorts(includeAllSerial:Boolean = false, includeAll:Boolean = false):Array
		{
			...
			validComPorts.push("COM17");
			validComPorts.push("COM18");
			validComPorts.push("COM19");
			validComPorts.push("COM20");
			validComPorts.push("COM21");
			validComPorts.push("COM22");
			validComPorts.push("COM23");
			validComPorts.push("COM24");
			validComPorts.push("COM25");
			validComPorts.push("COM26");
			validComPorts.push("COM27");
			validComPorts.push("COM28");
			validComPorts.push("COM29");
			validComPorts.push("COM30");
			validComPorts.push("COM31");
			validComPorts.push("COM32");
